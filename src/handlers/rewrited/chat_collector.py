...
from src.data.bot_data import INVITE_ACCOUNT_TO_EXTERNAL_CHAT, SEND_LINK_TO_EXTERNAL_CHAT, \
    ADD_EXTERNAL_CHAT_CALLBACK, BACK_BUTTON_TEXT
from aiogram.dispatcher import FSMContext
from src.apis.db import get_connection_and_cursor, commit_and_close_connection_and_cursor
from src.data.config import EXTERNAL_CHATS, ID_COL, CHAT_URL
...
add_chat_kb.row(
    InlineKeyboardButton('Пригласить аккаунт', callback_data = INVITE_ACCOUNT_TO_EXTERNAL_CHAT),
    InlineKeyboardButton('Отправить ссылку', callback_data = SEND_LINK_TO_EXTERNAL_CHAT)
)
back_button = InlineKeyboardMarkup()
back_button.add(InlineKeyboardButton(BACK_BUTTON_TEXT, callback_data=ADD_EXTERNAL_CHAT_CALLBACK))
